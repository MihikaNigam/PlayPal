import{d as c,c as u,r as d,x as m,i as f,e as h,a as g}from"./lit-element-ChEvtA_T.js";import{n as p}from"./property-xm5xGIk0.js";var _=Object.defineProperty,v=(n,e,s,i)=>{for(var r=void 0,o=n.length-1,l;o>=0;o--)(l=n[o])&&(r=l(e,s,r)||r);return r&&_(e,s,r),r};c({"restful-form":u.FormElement});const a=class a extends d{constructor(){super(...arguments),this.message=""}render(){return m`
      <restful-form new .init=${{username:"",password:""}}
        src="/auth/login"
